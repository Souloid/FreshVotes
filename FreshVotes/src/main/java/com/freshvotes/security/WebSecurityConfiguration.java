...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	@Bean // This is to get the returned Bcrypt to be usable outside this file. Defining it as a bean makes it a pseudo class managed by spring
	...
	protected void configure(HttpSecurity http) throws Exception {
		//idk why he's disabling this, should be explained later. i don't even know what this is.
		http
